...
<table class="table table-striped">
 ...
 <tr>
      ...
      <td><a href="mesaj-detay?gidenmesaj=ok&mesaj_id=<?php echo $mesajcek['mesaj_id'] ?>&kullanici_gon=<?php echo $mesajcek['kullanici_gon'] ?>"><button class="btn btn-primary btn-xs">Mesaj Oku</button></a></td>
