...
<?php
 ...
 if($mesajcek['mesaj_okunma']==0){?>
        ...
        <i style="color: green" class="fa fa-circle" aria-hidden="true"></td>
...
<?php } else { ?>
 ...
 <?php } 
    ?>      
      ...
      <td><a href="mesaj-detay?mesaj_id=<?php echo $mesajcek['mesaj_id'] ?>&kullanici_gon=<?php echo $mesajcek['kullanici_gon'] ?>"><button class="btn btn-primary btn-xs">Mesaj Oku</button></a></td>
