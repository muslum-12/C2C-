                        ...
                        <div class="tab-pane fade active in" id="Personal">
                            ...
                            <div class="personal-info inner-page-padding">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Mevcut Fotoğtraf</label>
                                    <div class="col-sm-9">
                                        <img width="270"src="<?php echo $uruncek['urunfoto_resimyol'];?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                            ...
                                            <select name="kategori_id"class='select2'>
                                                <?php 
                                                    //Belirli veriyi seçme işlemi
                                                     ...
                                                     ?>
                                                <option <?php if($kategoricek['kategori_id']==$uruncek['kategori_id']){ echo "selected"; }?> value="<?php echo $kategoricek['kategori_id']?>"><?php echo $kategoricek['kategori_ad']?>
                                                </option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea  class="ckeditor" id="editor1" name="urun_detay"> <?php echo $uruncek['urun_detay'] ?>
                                        </textarea>
                                    </div>
                                </div>
