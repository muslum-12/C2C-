                ...
                <div class="footer-area-top">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="footer-box">
                                    <h3 class="title-bar-left title-bar-footer">Destek </h3>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="footer-box">
                                    <h3 class="title-bar-left title-bar-footer">Sosyal Medya İletişim</h3>
                                    <ul class="footer-social">
                                        ...
                                        <li><a href="<?php echo $ayarcek ['ayar_google']?>"targer="_blank"><i class=" fa fa-google" aria-hidden="true"></i></a></li>
                                    </ul>
