 ...
 <div class="settings-details tab-content">
   ...
   <div class="form-group">
    ...
    <p><?php echo $mesajcek['mesaj_detay'] ?></p>
       ...
       <?php 
       if ($_GET['gidenmesaj']!="ok") { ?> <!--  kanka problem burda  bunun kapanışınıda,  şimdi problem bunun tnımsız olduğunu söylüyor-->
         ...
         <div class="form-group">
              ...
              <div class="col-sm-9">
             <textarea  class="ckeditor" id="editor1" name="mesaj_detay"placeholder="Ürün Açılması"></textarea>
                 </div>
                   </div>  
