...
<option value="<?php echo $kategoricek['kategori_id']?>"><?php echo $kategoricek['kategori_ad']?></option>
   ...
   <div class="form-group">
        ...
        <div class="col-sm-9">
        <input class="form-control"required=""name="urun_ad" id="Company-name"placeholder="Ürün adı.."type="text">
        </div>
    </div>
   ...
   <div class="form-group">
        ...
        <div class="col-sm-9">
       <textarea  class="ckeditor" id="editor1" name="urun_detay"placeholder="Ürün Açılması"></textarea>
           </div>
             </div>  
 ...
 <div class="form-group">
        ...
        <div class="col-sm-9">
        <input class="form-control"required=""name="urun_fiyat" id="Company-name"placeholder="Ürün fiyatı girin.."type="text">
        </div>
    </div>
